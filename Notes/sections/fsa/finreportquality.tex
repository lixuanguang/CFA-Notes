...
\begin{remark} \hlt{Persistence of Earnings}\\
...
\begin{method} \hlt{Accruals on Persistence of Earnings}\\
...
\begin{remark} \hlt{Classification of Accruals}\\
...
\begin{remark} \hlt{Signs of Possible Earnings Manipulation}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
...
\begin{remark} \hlt{Mean Reversion of Earnings}\\
...
\begin{remark} \hlt{Earnings Manipulation with Revenue Recognition}\\
...
\begin{remark} \hlt{Earnings Manipulation with Expense Recognition}\\
...
\begin{remark} \hlt{Indicators of Cash Flow Quality}\\
...
\begin{remark} \hlt{Indicators of Cash Flow Manipulation}\\
...
\begin{method} \hlt{Evaluation of Cash Flow Quality}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
...
\subsubsection{Balance Sheet Quality Analysis}

\begin{remark} \hlt{High Quality Balance Sheet Reporting}\\
Evidenced by completeness, unbiased measurement, clarity of presentation.
\end{remark}

\begin{remark} \hlt{Completeness}\\
...
\begin{remark} \hlt{Unbiased Measurement}\\
...
\begin{remark} \hlt{Clear Presentation} \\
...
\begin{remark} \hlt{Sources of Information about Risk}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
